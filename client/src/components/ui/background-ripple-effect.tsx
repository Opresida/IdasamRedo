  ...
  return (
    ...
    >
      <div className="absolute h-[20rem] inset-y-0 overflow-hidden">
        <div className="absolute h-full w-full pointer-events-none -bottom-2 z-40 bg-idasam-green-dark [mask-image:linear-gradient(to_bottom,transparent,black)]" />
        <div
        ...
        >
          <Pattern cellClassName="border-idasam-yellow-accent relative z-[100]" />
        </div>
        <Pattern className="opacity-[0.5]" cellClassName="border-idasam-green-medium" />
      </div>
    </div>
  );
};
          ...
          {row.map((column, colIdx) => {
            ...
            return (
              <div
                ...
                className={cn(
                  "bg-transparent border-l border-b border-idasam-green-medium/30",
                  cellClassName
                )}
              ...
              >
                <motion.div
                  ...
                  animate={controls}
                  className="bg-idasam-yellow-accent/30 h-12 w-12"
                />
              </div>
            );
          })}
